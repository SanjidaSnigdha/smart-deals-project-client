...
const Banner = () => {
  return (
    <div className="bg-gradient-to-b from-[#FFE6FD] to-[#E0F8F5] w-full mx-auto h-[550px] flex justify-center">
      ...
      {/* start */}
      <div className="join rounded-4xl items-center text-center">
        <div>
          <div>
            <input
